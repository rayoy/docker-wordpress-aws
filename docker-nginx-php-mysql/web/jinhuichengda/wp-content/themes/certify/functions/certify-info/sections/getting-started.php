	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<p><?php esc_html_e( 'This theme is ideal for creating corporate and business websites. There is no separate premium version of the Certify theme, Certify is a child theme of SpicePress WordPress theme and premium version of  SpicePress have tons of features: a homepage with many sections where you can feature unlimited slides, portfolios, user reviews, latest news, services, calls to action and much more. Each section in the Homepage template is carefully designed to fit to all business requirements.','certify');?></p>
				<p>
